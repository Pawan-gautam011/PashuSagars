...
class Appointment(models.Model):
    ...
    veterinarian = models.ForeignKey(
        settings.AUTH_USER_MODEL, related_name='veterinarian_appointments', 
        on_delete=models.CASCADE, limit_choices_to={'role': 2}, blank=True, null=True
    )  # New field to link a vet
